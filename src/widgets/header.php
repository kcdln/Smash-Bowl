...
<header>
    <div class="header-container d-flex align-items-center justify-content-around">
        ...
        <nav class="d-none d-md-block nav nav-pills">
            <ul>
                <li><a class="flex-md-fill text-md-center nav-link" href="<?= $sPath; ?>src/views/login.php">Se connecter</a></li>
                <li><a class="flex-md-fill text-md-center nav-link" href="<?= $sPath; ?>src/views/match/list.php">Voir les matchs</a></li>
